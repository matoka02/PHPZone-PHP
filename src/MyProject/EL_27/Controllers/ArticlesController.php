...
use src\MyProject\EL_27\Exceptions\NotFoundException;
...
class ArticlesController
{
  ...
  public function view(int $articleId): void
  {
    ...
    $this->view->renderHtml('EL_27/articles/view.php', ['article' => $article]);
  }
  ...
  public function edit(int $articleId): void
  {
    ...
    $article = Article::getById($articleId);
    if ($article === null) {
      $this->view->renderHtml('EL_27/errors/404.php', [], 404);
      return;
    }
